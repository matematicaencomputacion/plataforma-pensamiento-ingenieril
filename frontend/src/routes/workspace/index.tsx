    ...
    <main class="workspace">
      <header class="workspace__header">
        <div class="workspace__brand-row">
          ...
          <div class="workspace__header-tools">
            <ToolStackBar />
...
export const head: DocumentHead = {
  title: `Workspace · ${BRAND_NAME_PLAIN}`,
  meta: [
    {
      name: "description",
      content:
        "IngenierIA — workspace del estudiante para escribir y evaluar ejercicios de Python.",
    },
  ],
};
