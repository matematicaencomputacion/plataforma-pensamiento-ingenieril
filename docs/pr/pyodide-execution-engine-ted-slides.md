...
## Slide 2 — Insight
#39 abrió `/learn` y Validar; faltaba cerrar la rebanada de ejecución interactiva (Run + consola + nivel operativo) con E2E explícito de `print`.
...
- Statement vía `GET /api/levels/current`; E2E `exercise.spec.ts` (ADR 002).
