//! First coding micro-steps for Paso 2 (embedded from foundations seed).
//!
//! Source of truth for copy: `docs/seeds/python-foundations-microsteps-v0.2.json`
//! (`py-02-variables`). Keep in sync until a JSON loader lands.
