...
/// Rail capacity toward the 406-micro-step roadmap (cells beyond filled curriculum stay locked).
const MICRO_STEP_COUNT: i32 = 406;
...
fn MicroStepRail(
    ...
    view! {
        <ol
            ...
            aria-label="Python micro-step challenges 1 to 406"
