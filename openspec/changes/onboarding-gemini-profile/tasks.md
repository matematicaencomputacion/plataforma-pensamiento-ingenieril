...
## 2. Adapter Gemini (Vertex)

- [x] 2.1 Adapter Vertex/Gemini con ADC + env (`GOOGLE_CLOUD_PROJECT`, `VERTEX_LOCATION`, `GEMINI_MODEL`)
- [x] 2.2 Prompt de sistema + parseo JSON estricto (strip fences)
- [x] 2.3 Selección mock vs gemini vía `LEARNER_PROFILE_LLM`
...
- [x] 3.3 Actualizar `.env.example` con variables Vertex/modelo
