"""Valida los 60 micro-steps (2381-2440) de la Ola 24 ejecutando sus pytest en Python.

Reusa la definición de pasos de `gen_wave24.py` (sin input, stdlib-only, determinista).
...
def main():
    ...
    if failed:
        ...
        for f in failed:
            print("  ", f)
        sys.exit(1)
    print("All 60 wave-24 steps pass.")
