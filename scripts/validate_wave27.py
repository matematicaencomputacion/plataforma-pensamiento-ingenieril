"""Valida los 60 micro-steps (2561-2620) de la Ola 27 ejecutando sus pytest en Python.

Reusa la definición de pasos de `gen_wave27.py` (sin input, stdlib-only, determinista).
...
def main():
    steps = gen_wave27.build_raw(gen_wave27.RAW)
    ...
    if failed:
        ...
        for f in failed:
            print("  ", f)
        sys.exit(1)
    print("All 60 wave-27 steps pass.")
