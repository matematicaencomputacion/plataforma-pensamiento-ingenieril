...
def main():
    ...
    assert catalog == list(range(1, 2741)), "catalog must be exact and ordered 1..=2740"
    for step in steps:
    ...
    for path in E2E:
        assert path.read_text(encoding="utf-8").count("toHaveCount(2740)") == 1
    print(f"Wave 29 contract OK: 60 solutions passed; {lazy_count} lazy/short-circuit exercises; catalog exact 1..=2740")
