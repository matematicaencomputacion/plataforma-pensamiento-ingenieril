"""Valida los 60 micro-steps (2681-2740) de la Ola 29 ejecutando sus pytest en Python.

Reusa la definición de pasos de `gen_wave29.py` (sin input, stdlib-only, determinista).
...
def main():
    ...
    if failed:
        ...
        for f in failed:
            print("  ", f)
        sys.exit(1)
    print("All 60 wave-29 steps pass.")
