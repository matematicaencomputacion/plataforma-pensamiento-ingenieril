"""Valida los 60 micro-steps (2621-2680) de la Ola 28 ejecutando sus pytest en Python.

Reusa la definición de pasos de `gen_wave28.py` (sin input, stdlib-only, determinista).
...
def main():
    steps = gen_wave28.build_raw(gen_wave28.RAW)
    ...
    if failed:
        ...
        for f in failed:
            print("  ", f)
        sys.exit(1)
    print("All 60 wave-28 steps pass.")
