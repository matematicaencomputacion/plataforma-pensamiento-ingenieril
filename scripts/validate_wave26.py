"""Valida los 60 micro-steps (2501-2560) de la Ola 26 ejecutando sus pytest en Python.

Reusa la definición de pasos de `gen_wave26.py` (sin input, stdlib-only, determinista).
...
def main():
    ...
    if failed:
        ...
        for f in failed:
            print("  ", f)
        sys.exit(1)
    print("All 60 wave-26 steps pass.")
