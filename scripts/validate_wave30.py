...
def main():
    ...
    assert catalog == list(range(1, 2801)), "catalog must be exact and ordered 1..=2800"
    for step in steps:
    ...
    for path in E2E:
        assert path.read_text(encoding="utf-8").count("toHaveCount(2800)") == 1
    ...
    print("Wave 30 contract OK: 60 solutions passed; 10x6 families; catalog exact 1..=2800")
