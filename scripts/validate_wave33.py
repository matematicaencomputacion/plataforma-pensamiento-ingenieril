"""Valida los 60 micro-steps (2921-2980) de la Ola 33 ejecutando sus pytest en Python.

Reusa la definición de pasos de `gen_wave33.py` (sin input, stdlib-only, determinista).
"""
...
sys.path.insert(0, os.path.dirname(os.path.abspify(__file__)))
import gen_wave33  # noqa: E402
...
def main():
    steps = gen_wave33.build_raw(gen_wave33.RAW)
    ...
    if failed:
        ...
        for f in failed:
            print("  ", f)
        sys.exit(1)
    print("All 60 wave-33 steps pass.")
