"""Valida los 60 micro-steps (2801-2860) de la Ola 31 ejecutando sus pytest en Python.

Reusa la definición de pasos de `gen_wave31.py` (sin input, stdlib-only, determinista).
"""
...
def main():
    ...
    if failed:
        ...
        for f in failed:
            print("  ", f)
        sys.exit(1)
    print("All 60 wave-31 steps pass.")
