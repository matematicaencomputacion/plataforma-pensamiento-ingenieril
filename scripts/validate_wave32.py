"""Valida los 60 micro-steps (2861-2920) de la Ola 32 ejecutando sus pytest en Python.

Reusa la definición de pasos de `gen_wave32.py` (sin input, stdlib-only, determinista).
"""
...
def main():
    ...
    if failed:
        ...
        for f in failed:
            print("  ", f)
        sys.exit(1)
    print("All 60 wave-32 steps pass.")
